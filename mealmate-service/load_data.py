        ...
        with pool.connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    ...
                    insert into users (first_name, last_name, username, email, hashed_password, picture_url, role_id) values ('Amy', 'Smith', 'amysmith', 'amysmith@gmail.com', 'password', 'https://arc-anglerfish-arc2-prod-tronc.s3.amazonaws.com/public/65X4LYTHFNBTJLY3R45NPSWO7I.jpg', 2);
