        ...
        with pool.connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    ...
                    insert into meals (name, description, picture_url, chef_id, instructions, ingredients) values ('Chicken Parm', 'Chicken Parmesan is a dish of chicken cutlet, topped with tomato sauce and melted cheese, usually mozzarella. It is a common dish in Italian-American cuisine.', 'https://images.unsplash.com/photo-1588778144311-8c1f2f1b2b1a?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y2hpY2tlbiUyMHBhcm1lbnRhbCUyMGN1dGxldCUyMGNvZGV8ZW58MHx8MHx8&ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=60', 2, 'instructions', 'ingredients');
                    insert into meals (name, description, picture_url, chef_id, instructions, ingredients) values ('Fish Parm', 'Chicken Parmesan is a dish of chicken cutlet, topped with tomato sauce and melted cheese, usually mozzarella. It is a common dish in Italian-American cuisine.', 'https://images.unsplash.com/photo-1588778144311-8c1f2f1b2b1a?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y2hpY2tlbiUyMHBhcm1lbnRhbCUyMGN1dGxldCUyMGNvZGV8ZW58MHx8MHx8&ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=60', 2, 'instructions', 'ingredients');
                    insert into meals (name, description, picture_url, chef_id, instructions, ingredients) values ('Crab Parm', 'Chicken Parmesan is a dish of chicken cutlet, topped with tomato sauce and melted cheese, usually mozzarella. It is a common dish in Italian-American cuisine.', 'https://images.unsplash.com/photo-1588778144311-8c1f2f1b2b1a?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y2hpY2tlbiUyMHBhcm1lbnRhbCUyMGN1dGxldCUyMGNvZGV8ZW58MHx8MHx8&ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=60', 2, 'instructions', 'ingredients');
                    insert into meals (name, description, picture_url, chef_id, instructions, ingredients) values ('Beef Parm', 'Chicken Parmesan is a dish of chicken cutlet, topped with tomato sauce and melted cheese, usually mozzarella. It is a common dish in Italian-American cuisine.', 'https://images.unsplash.com/photo-1588778144311-8c1f2f1b2b1a?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y2hpY2tlbiUyMHBhcm1lbnRhbCUyMGN1dGxldCUyMGNvZGV8ZW58MHx8MHx8&ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=60', 2, 'instructions', 'ingredients');
