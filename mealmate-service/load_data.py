            ...
            with conn.cursor() as cur:
                ...
                cur.execute(
                    ...
                    DECLARE
                        ...
                        meal_id integer;
                        num_records integer;
                        subscriber_ids integer[] := ARRAY[1,3,5,7,9,11,12,13,14,15];
                    BEGIN
                        FOREACH order_id IN ARRAY subscriber_ids LOOP
                            IF order_id BETWEEN 1 AND 50 THEN
